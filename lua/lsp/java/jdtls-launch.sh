...
# https://ftp.fau.de/eclipse/jdtls/snapshots/
JAR="$HOME/lsp-servers/jdtls/plugins/org.eclipse.equinox.launcher_*.jar"  # This is where your OWN jdtls locates
GRADLE_HOME=$HOME/gradle /usr/lib/jvm/java-11-openjdk/bin/java \
  ...
  -Xmx2G \
  -jar $(echo "$JAR") \
  -configuration "$HOME/lsp-servers/jdtls/config_linux" \
